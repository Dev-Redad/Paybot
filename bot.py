...
FORCE_SUBSCRIBE_CHANNEL_IDS = [int(channel_id.strip()) for channel_id in FORCE_SUBSCRIBE_CHANNEL_IDS_STR.split(',') if channel_id]
FORCE_SUBSCRIBE_ENABLED = os.getenv("FORCE_SUBSCRIBE_ENABLED", "True").lower() == "true"
PROTECT_CONTENT_ENABLED = os.getenv("PROTECT_CONTENT", "True").lower() == "true"
...
def add_product_start(update: Update, context: CallbackContext):
    ...
    # Handle the first file immediately
